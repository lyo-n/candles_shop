...
<article class="card card--1">
  ...
  <a href="#no_scroll" class="card_link">
     <div class="card__img--hover"></div>
   </a>
  <div class="card__info">
    <span class="card__category"> Recipe</span>
    <h3 class="card__title">Crisp Spanish tortilla Matzo brei</h3>
    <span class="card__by">by <a href="#no_scroll" class="card__author" title="author">Celeste Mills</a></span>
  </div>
</article>
...
<article class="card card--2">
  ...
  <div class="card__info">
    ...
    <span class="card__by">by <a href="#no_scroll" class="card__author" title="author">John Doe</a></span>
  </div>
</article>  
